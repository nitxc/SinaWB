...
- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (touchingLink) {
        // 说明手指在某个链接上面抬起来, 发出通知
        [[NSNotificationCenter defaultCenter] postNotificationName:SWLinkDidSelectedNotification object:nil userInfo:@{SWLinkAttr : touchingLink.text}];
    }
