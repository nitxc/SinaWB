...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
       ...
       UIButton *emotionBtn =  [self addButtonWithIcon:@"compose_emoticonbutton_background" highIcon:@"compose_emoticonbutton_background_highlighted" tag:SWComposeToolbarButtonTypeEmotion];
