...
+ (void)setupNavigationBarTheme
{
    ...
    textAttrs[NSFontAttributeName] = SWNavigarionFont;
    // 设置导航栏背景
    if (!iOS7) {
...
+ (void)setupBarButtonItemTheme
{
    ...
    /**设置文字属性**/
    // 设置普通状态的文字属性
    [appearance setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:SWCommonColor, NSForegroundColorAttributeName,[UIFont systemFontOfSize:15],NSFontAttributeName,nil] forState:UIControlStateNormal];
