...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.backgroundColor = [UIColor whiteColor];//设置导航的背景颜色
...
{
    // 通知代理
    if ([self.tarbarDelegate respondsToSelector:@selector(tabBarDidClickedPlusButton:)]) {
        [self.tarbarDelegate tabBarDidClickedPlusButton:self];
    }
}
