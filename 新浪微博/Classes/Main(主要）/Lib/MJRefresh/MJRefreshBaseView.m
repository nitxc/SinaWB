...
@interface  MJRefreshBaseView()
{
    ...
    __weak MJReshActivityIndicatorView *_activityView;
    BOOL _endingRefresh;
}
@end
 ...
 *  状态标签
 */
- (MJReshActivityIndicatorView *)activityView
{
    if (!_activityView) {
        MJReshActivityIndicatorView *activityView = [[MJReshActivityIndicatorView alloc] init];
...
- (void)layoutSubviews
{
    ...
    // 1.箭头
    CGFloat arrowX = self.mj_width * 0.5-35;
    self.arrowImage.center = CGPointMake(arrowX, self.mj_height * 0.5-15);
